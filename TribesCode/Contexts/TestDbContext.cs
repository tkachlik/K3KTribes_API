...
namespace dusicyon_midnight_tribes_backend.Contexts
{
    ...
    public class TestDbContext : DbContext, IContext
    {
        ...
        public TestDbContext(DbContextOptions<TestDbContext> options, ISeedData seedData) : base(options)
        {
            _seedData = seedData;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //// DB SEEDING WITH CUSTOM TEST DATA (PRIMARILY FOR EASE OF TESTING IN DEV ENV AND DEMOS)
